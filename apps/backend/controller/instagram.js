...
export const loginInstagram = asyncHandler(async (req, res) => {
  ...
  res.redirect(`https://api.instagram.com/oauth/authorize?client_id=785166699786224&redirect_uri=https://kullaj-social-media.onrender.com/users/get-user-code&scope=user_profile,user_media&response_type=code`);
});
